        ...
        <Box sx={{
...

            {
                ...
                <Box mt={'2rem'}>
                {
                    provider ? 
                    <>
                    <ButtonWithIcon onClick={() => login()} icon={<IconButton background={DEFAULT_COLORS.White} color={DEFAULT_COLORS.Blue}> <ArrowForwardIcon sx={{color:DEFAULT_COLORS.Blue}} /></IconButton>} fullWidth background={DEFAULT_COLORS.Blue} >You are already registered</ButtonWithIcon>
                    <span style={{cursor: "pointer"}} onClick={() => logout()}>Log out</span>
                    </>
                    :
                    <ButtonWithIcon onClick={() => login()} icon={<IconButton background={DEFAULT_COLORS.White} color={DEFAULT_COLORS.Blue}> <ArrowForwardIcon sx={{color:DEFAULT_COLORS.Blue}} /></IconButton>} fullWidth background={DEFAULT_COLORS.Blue} >Sign up</ButtonWithIcon>
                }
